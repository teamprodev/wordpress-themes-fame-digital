<?php
/**
 * Class Name: fame_wp_bootstrap_navwalker
...
class fame_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			$item_output .= ( 0 === $depth ) ? '<span class="nav-dots"></span>' : '';
