 ...
 */
require_once FAME_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'fame_register_required_plugins' );
 ...
 */
function fame_register_required_plugins() {
	/*
    ...
    // Codestar Framework
		array(
			...
			'source'             => FAME_FRAMEWORK . '/plugins/codestar-framework.zip',
			'required'           => true,
			'version'            => '2.0.9',
		),
    // Elementor
    ...
    array(
		...
		// Fame Core
		array(
			'name'               => esc_html__( 'Fame Core', 'fame' ),
			'slug'               => 'fame-core',
			'source'             => 'https://victorthemes.com/plugins/fame-core.zip',
			'required'           => true,
		),
